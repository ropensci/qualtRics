...
You can read a survey that you downloaded manually from Qualtrics' website via a browser using `readSurvey()`:

```{r, eval=FALSE}
mysurvey <- readSurvey("/users/Julia/Desktop/mysurvey.csv")
```
